...
let numeroSorteadoData = dataAtualSistema.getDate();

console.log('Numero escolhido: ',numeroSorteadoData);
numeroSorteadoData--;

let fraseEscolhida = frases[numeroSorteadoData];

console.log('Frase Do Dia é: ', fraseEscolhida);
...
console.log('Némero sorteado é: ',numero_escolhido);
numero_escolhido--;

let fraseDia = frases[numero_escolhido];

console.log('--Frase do dia--');
console.log('Mesagem: ', fraseDia);
*/
